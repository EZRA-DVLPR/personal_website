...
const images = [
    ...
    { src: '/static/art/ohmshirt.jpeg', title: 'Ohm Shirt', description: 'For my art class, we were tasked with wandering campus to find and utilize the environment to frame objects to draw attention. I took my shirt off and wanted to show the color variety of the Ohm symbol so I picked a neutral background of the rocks, and scoured the nearby area for colored rocks to balance the color variety from the shirt.', date: '2023-05-01' },
    { src: '/static/art/redscrunchie.jpeg', title: 'Red Scrunchie', description: 'For my art class, we were tasked with wandering campus to find and utilize the environment to frame objects to draw attention. For this image, I found a scrunchie that could be used with the red tarps above.', date: '2023-05-01' },
