...
const images = [
  ...
  {
    src: '/static/art/butterfly.jpg',
    title: 'A butterfly I drew with Cross Hatching',
    description:
      'For my art class, we were given this slip of paper with the outline of the butterfly. We were then told to fill in the image using only the cross hatching technique.',
    date: '2023-05-02',
  },
  {
