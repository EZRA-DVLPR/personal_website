...
const projectsData: Project[] = [
	{
		title: "Thesis",
		description:
			"Explored what Turing Completeness looks like in different discipliens and proved that Proteus is Turing Complete through a variety of techniques",
		status: "Completed",
	...
	},
	{
		title: "GameList",
		description:
			"Local Database manager with UI that scrapes HLTB and Completionator for Game Information",
		status: "Completed",
	...
	},
	{
		...
		description:
			"Utilizes Implicit DL and standard DM practices for recommending music to users",
		status: "Completed",
	...
	},
	{
		...
		description:
			"Boilerplate project for the MERN Stack. Highly simplistic and lightweight",
		status: "Completed",
	...
	},
	{
		title: "The Crucible",
		description:
			"Frame.IO integration for automating several tasks using scripting",
		status: "Completed",
	...
	},
	{
		title: "Monster Farm",
		description:
			"Mobile Game about farming and resource management with cute monsters",
		status: "Planned",
	},
	{
		title: "2D/3D Maze",
	...
	},
	{
		title: "Dice Roller",
		description:
			"Program to roll up to 20 dice of any standard shape eg. d4, d20",
		status: "Planned",
	},
	{
	...
	},
	{
		title: "Hydra Virus",
		description:
			"Create a virus like the fork virus to spawn itself repeatedly",
		status: "Planned",
	},
	{
